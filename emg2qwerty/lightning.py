...
class TransformerCTCModule(pl.LightningModule):
    ...
    def __init__(
        ...
        # CTC head
        self.output = nn.Linear(d_model, charset().num_classes)
    ...
    def _step(
        ...
        # Transformer encoder does not change temporal resolution, so
        # inputs and emissions have the same time dimension.
        T_diff = inputs.shape[0] - emissions.shape[0]
        emission_lengths = input_lengths - T_diff
